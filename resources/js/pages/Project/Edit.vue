                    ...
                    <form @submit.prevent="submit" class="form theme-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <!-- -->
                                <div class="mb-3">
                                    <label>Доступ у пользователей</label>
                                    <n-select
                                        v-model:value="form.users"
                                        filterable
                                        multiple
                                        placeholder="Доступ у пользователей"
                                        :options="users"
                                    />
                                </div>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <div class="text-start">
                                    <button class="btn btn-primary me-3" :disabled="upload_process" type="submit">Обновить проект</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
const props = defineProps({ regions: Array, project: Object, users: Array })
...
const form = useForm({
    ...
    yandex_region_id: props.project['yandex_region_id'],
    parse_period: props.project['parse_period'],
    parse_time: new Date(props.project['parse_time']),
    parse_week_days: props.project['parse_week_days'],
    users: props.project['users_ids'],
})
