    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><Link href="/">Все проекты</Link></li>
                    <li class="breadcrumb-item"><Link href="/users">Все пользователи</Link></li>
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <div class="text-start">
                                    <button class="btn btn-primary me-3" type="submit">Обновить пользователя</button>
                                </div>
                            </div>
                        </div>
                    </form>
